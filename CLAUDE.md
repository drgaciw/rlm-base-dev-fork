...
- GitNexus must not inject context into this file or `AGENTS.md`; the committed `.gitnexusrc` (`skipAgentsMd`, `skipSkills`) enforces that on every `analyze` run — do not remove it.
